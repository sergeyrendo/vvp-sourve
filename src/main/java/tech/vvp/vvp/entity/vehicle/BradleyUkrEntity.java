...
public class BradleyUkrEntity extends ContainerMobileVehicleEntity implements GeoEntity, LandArmorEntity, WeaponVehicleEntity, OBBEntity {
    ...
    public static final EntityDataAccessor<Integer> CANNON_FIRE_TIME = SynchedEntityData.defineId(BradleyUkrEntity.class, EntityDataSerializers.INT);
    ...
    public static final EntityDataAccessor<Integer> MG_AMMO = SynchedEntityData.defineId(BradleyUkrEntity.class, EntityDataSerializers.INT);
