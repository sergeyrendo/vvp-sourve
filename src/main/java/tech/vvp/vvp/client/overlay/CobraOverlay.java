...
@OnlyIn(Dist.CLIENT)
public class CobraOverlay implements IGuiOverlay {
    public static final String ID = VVP.MOD_ID + "_cobra_hud";
    ...
    public void render(ForgeGui gui, GuiGraphics guiGraphics, float partialTick, int screenWidth, int screenHeight) {
        ...
        Entity targetEntity = EntityFindUtil.findEntity(player.level(), supercobra.getTargetUuid());
        List<Entity> entities = SeekTool.seekCustomSizeEntities(supercobra, player.level(), 384, 20, 0.9, true);
        ...
        for (Entity e : entities) {
            ...
            boolean lockOn = supercobra.locked && nearest;
            ...
            if (lockOn) {
                ...
                lerpLock = Mth.lerp(partialTick, lerpLock, 2 * supercobra.lockTime);
