...
public class Bmp2MEntity extends ContainerMobileVehicleEntity implements GeoEntity, LandArmorEntity, WeaponVehicleEntity, OBBEntity {

    public static final EntityDataAccessor<Integer> CANNON_FIRE_TIME = SynchedEntityData.defineId(Bmp2MEntity.class, EntityDataSerializers.INT);
    public static final EntityDataAccessor<Integer> LOADED_MISSILE = SynchedEntityData.defineId(Bmp2MEntity.class, EntityDataSerializers.INT);
    public static final EntityDataAccessor<Integer> MISSILE_COUNT = SynchedEntityData.defineId(Bmp2MEntity.class, EntityDataSerializers.INT);
    public static final EntityDataAccessor<Integer> MG_AMMO = SynchedEntityData.defineId(Bmp2MEntity.class, EntityDataSerializers.INT);
    public static final EntityDataAccessor<Integer> CURRENT_MISSILE = SynchedEntityData.defineId(Bmp2MEntity.class, EntityDataSerializers.INT);
    public static final EntityDataAccessor<Integer> CAMOUFLAGE_TYPE = SynchedEntityData.defineId(Bmp2MEntity.class, EntityDataSerializers.INT);
    public static final EntityDataAccessor<Integer> MISSILE_FIRE_COOLDOWN = SynchedEntityData.defineId(Bmp2MEntity.class, EntityDataSerializers.INT);
    public static final EntityDataAccessor<Boolean> HAS_MANGAL = SynchedEntityData.defineId(Bmp2MEntity.class, EntityDataSerializers.BOOLEAN);
    public static final EntityDataAccessor<Boolean> HAS_FOLIAGE = SynchedEntityData.defineId(Bmp2MEntity.class, EntityDataSerializers.BOOLEAN);
    public static final EntityDataAccessor<Boolean> HAS_FOLIAGE_BODY = SynchedEntityData.defineId(Bmp2MEntity.class, EntityDataSerializers.BOOLEAN);
    public static final EntityDataAccessor<Boolean> LAST_MISSILE_LEFT =
            SynchedEntityData.defineId(Bmp2MEntity.class, EntityDataSerializers.BOOLEAN);
    ...
    public static final float X_TURRET = -1.1051f / 16f;
    public static final float Y_TURRET = 30.3344f / 16f;
    public static final float Z_TURRET = -17.3391f / 16f;

    private static final float MISSILE_MUZZLE_X_OFFSET = 24.425f/16f;
    private static final float MISSILE_MUZZLE_Y       =  0f/16f;
    private static final float MISSILE_MUZZLE_Z       = -17.1f/16f;
    ...
    private static final ResourceLocation GEO_MODEL = VVP.loc("geo/bmp2.geo.json");
    private static boolean LOCATORS_LOADED = false;
    private static Vector3f LOCATOR_DIRT_BACK_LEFT = new Vector3f(25f/16f, 0f/16f, -46f/16f);
    private static Vector3f LOCATOR_DIRT_BACK_RIGHT = new Vector3f(-25f/16f, 0f/16f, -46f/16f);

    private static Vector3f LOCATOR_DIRT_FRONT_LEFT = new Vector3f(25f/16f, 0f/16f, 31f/16f);
    private static Vector3f LOCATOR_DIRT_FRONT_RIGHT = new Vector3f(-25f/16f, 0f/16f, 31f/16f);

    public Bmp2MEntity(PlayMessages.SpawnEntity packet, Level world) {
        this(ModEntities.BMP_2M.get(), world);
    }

    public Bmp2MEntity(EntityType<Bmp2MEntity> type, Level world) {
        super(type, world);
        this.setMaxUpStep(1.5f);
        this.obb1 = new OBB(this.position().toVector3f(), new Vector3f(43f/32f, 25.75f/32f, 106f/32f), new Quaternionf(), OBB.Part.BODY);
        this.obb2 = new OBB(this.position().toVector3f(), new Vector3f(43f/32f, 25.75f/32f, 27f/32f), new Quaternionf(), OBB.Part.ENGINE1);
        this.obb3 = new OBB(this.position().toVector3f(), new Vector3f(8f/32f, 22.75f/32f, 112.25f/32f), new Quaternionf(), OBB.Part.WHEEL_RIGHT);
        this.obb4 = new OBB(this.position().toVector3f(), new Vector3f(8f/32f, 22.75f/32f, 112.25f/32f), new Quaternionf(), OBB.Part.WHEEL_LEFT);
        this.obbTurret = new OBB(this.position().toVector3f(), new Vector3f(43f/32f, 10.75f/32f, 44f/32f), new Quaternionf(), OBB.Part.TURRET);
    ...
    public Vec3 getTurretShootPos(Entity entity, float ticks) {
        ...
        if (getWeaponIndex(0) == 0) {
            worldPosition = transformPosition(transform, 0f, -0.15f, 2.7f);
        } else if (getWeaponIndex(0) == 2) {
            worldPosition = transformPosition(transform, 0f, 0.35f, -0.5f);
        } else {
            worldPosition = transformPosition(transform, -0.2f, 0f, 0.45f);
        }
    ...
    @Override
    public void travel() {
        trackEngine(true, 0.020, VehicleConfigVVP.BMP_2_ENERGY_COST.get(), 0.47, 0.5, 1.9, 0.8, 0.21f, -0.16f, 0.0020f, 0.0010f, 0.1f);
    }
    ...
    public void positionRider(@NotNull Entity passenger, @NotNull MoveFunction callback) {
        ...
        Vector4f worldPosition;
        if (i == 0) {
            worldPosition = transformPosition(transform, -0.5f, -0.6f, 0.8f);
        } else if (i == 1) {
    ...
    public Matrix4f getBarrelTransform(float ticks) {
        ...
        Vector4f worldPosition = transformPosition(transform,  1.1051f/16f, 8.7327f/16f, 19.4448f/16f);
    ...
    private PlayState firePredicate(AnimationState<Bmp2MEntity> event) {
    ...
    public void updateOBB() {
        ...
        Vector4f worldPosition1 = transformPosition(transform, 0.5f/16f, 21.125f/16f, -13f/16f);
        ...
        Vector4f worldPosition2 = transformPosition(transform, 0.5f/16f, 21.125f/16f, 53.5f/16f);
        this.obb2.center().set(new Vector3f(worldPosition2.x, worldPosition2.y, worldPosition2.z));
        this.obb2.setRotation(VectorTool.combineRotations(1, this));

        Vector4f worldPosition3 = transformPosition(transform, 25f/16f, 11.625f/16f, -4.875f/16f);
        this.obb3.center().set(new Vector3f(worldPosition3.x, worldPosition3.y, worldPosition3.z));
        this.obb3.setRotation(VectorTool.combineRotations(1, this));

        Vector4f worldPosition4 = transformPosition(transform, -25f/16f, 11.625f/16f, -4.875f/16f);
        this.obb4.center().set(new Vector3f(worldPosition4.x, worldPosition4.y, worldPosition4.z));
        this.obb4.setRotation(VectorTool.combineRotations(1, this));

        Matrix4f transformT = getTurretTransform(1);
        Vector4f worldPositionT = transformPosition(transformT, 0.0f, 0.5f, 0.0f);
