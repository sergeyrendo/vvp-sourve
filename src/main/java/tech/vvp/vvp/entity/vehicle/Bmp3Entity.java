...
public class Bmp3Entity extends ContainerMobileVehicleEntity implements GeoEntity, LandArmorEntity, WeaponVehicleEntity, OBBEntity {

    public static final EntityDataAccessor<Integer> CANNON_FIRE_TIME = SynchedEntityData.defineId(Bmp3Entity.class, EntityDataSerializers.INT);
    public static final EntityDataAccessor<Integer> MG_AMMO = SynchedEntityData.defineId(Bmp3Entity.class, EntityDataSerializers.INT);
    ...
    public Bmp3Entity(PlayMessages.SpawnEntity packet, Level world) {
        this(tech.vvp.vvp.init.ModEntities.BMP_3.get(), world);
    }
    ...
    public Bmp3Entity(EntityType<Bmp3Entity> type, Level world) {
        ...
        this.obbTurret = new OBB(this.position().toVector3f(), new Vector3f(43f/32f, 8f/32f, 45f/32f), new Quaternionf(), OBB.Part.TURRET);
    ...
    public Vec3 getTurretShootPos(Entity entity, float ticks) {
        ...
        if (getWeaponIndex(0) == 0) {
            worldPosition = transformPosition(transform, -0.25f, -0.15f, 2.7f);
        } else if (getWeaponIndex(0) == 2) {
            worldPosition = transformPosition(transform, -0.1f, -0.15f, 2.7f);
        } else {
    ...
    public void positionRider(@NotNull Entity passenger, @NotNull MoveFunction callback) {
        ...
        Vector4f worldPosition;
        if (i == 0) {
            worldPosition = transformPosition(transform, 0.2f, -0.8f, 1f);
        } else if (i == 1) {
