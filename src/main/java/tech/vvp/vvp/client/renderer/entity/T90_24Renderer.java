...
import tech.vvp.vvp.client.model.T90_24Model;
import tech.vvp.vvp.entity.vehicle.T90_24Entity;

import static com.atsuishio.superbwarfare.entity.vehicle.Yx100Entity.YAW;

public class T90_24Renderer extends GeoEntityRenderer<T90_24Entity> {

    public T90_24Renderer(EntityRendererProvider.Context renderManager) {
        super(renderManager, new T90_24Model());
//        this.addRenderLayer(new Yx100GlowLayer(this));
    }

    @Override
    public RenderType getRenderType(T90_24Entity animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
        return RenderType.entityTranslucent(getTextureLocation(animatable));
    }

    @Override
    public void preRender(PoseStack poseStack, T90_24Entity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green,
    ...
    @Override
    public void render(T90_24Entity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
        poseStack.pushPose();
    ...
    @Override
    public void renderRecursively(PoseStack poseStack, T90_24Entity animatable, GeoBone bone, RenderType renderType, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
