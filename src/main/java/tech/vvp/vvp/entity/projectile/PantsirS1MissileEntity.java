...
public class PantsirS1MissileEntity extends FastThrowableProjectile implements GeoEntity, ExplosiveProjectile {
    ...
    public static final EntityDataAccessor<Boolean> TOP_ATTACK = SynchedEntityData.defineId(PantsirS1MissileEntity.class, EntityDataSerializers.BOOLEAN);
    public static final EntityDataAccessor<String> TARGET_UUID = SynchedEntityData.defineId(PantsirS1MissileEntity.class, EntityDataSerializers.STRING);
    ...
    public PantsirS1MissileEntity(EntityType<? extends PantsirS1MissileEntity> type, Level level) {
        super(type, level);
        this.noCulling = true;
    }

    public PantsirS1MissileEntity(LivingEntity shooter, Level level, float damage, float explosionDamage, 
                                   float explosionRadius, int guideType, @Nullable Vec3 targetPos) {
        super(ModEntities.PANTSIR_S1_MISSILE.get(), shooter, level);
        this.noCulling = true;
        this.damage = damage;
    ...
    public PantsirS1MissileEntity(PlayMessages.SpawnEntity spawnEntity, Level level) {
        this(ModEntities.PANTSIR_S1_MISSILE.get(), level);
    }
    ...
    private PlayState predicate(AnimationState<PantsirS1MissileEntity> event) {
        event.getController().setAnimation(RawAnimation.begin().thenLoop("animation.pantsir_s1_missile.idle"));
