...
public class M142HimarsRenderer extends GeoEntityRenderer<M142HimarsEntity> {
    ...
    @Override
    public RenderType getRenderType(M142HimarsEntity animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
        return RenderType.entityTranslucent(getTextureLocation(animatable));
    }

    @Override
    public void preRender(PoseStack poseStack, M142HimarsEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green,
    ...
    @Override
    public void render(M142HimarsEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
        poseStack.pushPose();
    ...
    public float getBoneRotX(float t) {
        ...
        if (t <= 76.1667) return Mth.lerp((t - 75.6667F) / (76.1667F - 76.1667F), -242.5F, -295F);
