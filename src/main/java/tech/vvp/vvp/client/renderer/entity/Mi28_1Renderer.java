...
public class Mi28_1Renderer extends GeoEntityRenderer<Mi28_1Entity> {
    ...
    public void renderRecursively(PoseStack poseStack, Mi28_1Entity animatable, GeoBone bone, RenderType renderType, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
        ...
        if (name.equals("raketa_1")) {
            bone.setHidden(animatable.getEntityData().get(Mi28_1Entity.LOADED_MISSILE) < 1);
        }
        if (name.equals("raketa_2")) {
            bone.setHidden(animatable.getEntityData().get(Mi28_1Entity.LOADED_MISSILE) < 2);
        }
        if (name.equals("raketa_3")) {
            bone.setHidden(animatable.getEntityData().get(Mi28_1Entity.LOADED_MISSILE) < 3);
        }
        if (name.equals("raketa_4")) {
            bone.setHidden(animatable.getEntityData().get(Mi28_1Entity.LOADED_MISSILE) < 4);
        }
