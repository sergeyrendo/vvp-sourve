...
public class Uh60Entity extends ContainerMobileVehicleEntity implements GeoEntity, HelicopterEntity, WeaponVehicleEntity, OBBEntity {
    ...
    public static final EntityDataAccessor<Integer> LOADED_ROCKET = SynchedEntityData.defineId(Uh60Entity.class, EntityDataSerializers.INT);
    public static final EntityDataAccessor<Integer> LOADED_MISSILE = SynchedEntityData.defineId(Uh60Entity.class, EntityDataSerializers.INT);
    public static final EntityDataAccessor<Boolean> DOOR_RIGHT_OPEN = SynchedEntityData.defineId(Uh60Entity.class, EntityDataSerializers.BOOLEAN);
    public static final EntityDataAccessor<Boolean> DOOR_LEFT_OPEN = SynchedEntityData.defineId(Uh60Entity.class, EntityDataSerializers.BOOLEAN);
    public static final EntityDataAccessor<Integer> CAMOUFLAGE_TYPE = SynchedEntityData.defineId(Uh60Entity.class, EntityDataSerializers.INT);
    ...
    public Uh60Entity(PlayMessages.SpawnEntity packet, Level world) {
        this(ModEntities.UH60.get(), world);
    }
        ...
        if (getHealth() > 0.1f * getMaxHealth()) {
            ...
            if (this.level() instanceof ServerLevel) {
                if (this.getEnergy() > 0) {
                    ...
                    if (!engineStart && up) {
                        engineStart = true;
                        this.level().playSound(null, this, tech.vvp.vvp.init.ModSounds.UH60_START.get(), this.getSoundSource(), 3, 1);
                    }
    ...
    public SoundEvent getEngineSound() {
        return tech.vvp.vvp.init.ModSounds.UH60_IDLE.get();
    }
