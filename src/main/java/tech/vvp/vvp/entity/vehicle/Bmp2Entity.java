...
public class Bmp2Entity extends ContainerMobileVehicleEntity implements GeoEntity, LandArmorEntity, WeaponVehicleEntity, OBBEntity {
    ...
    public static final EntityDataAccessor<Integer> CAMOUFLAGE_TYPE = SynchedEntityData.defineId(Bmp2Entity.class, EntityDataSerializers.INT);
    public static final EntityDataAccessor<Boolean> HAS_CACTUS_BODY = SynchedEntityData.defineId(Bmp2Entity.class, EntityDataSerializers.BOOLEAN);
    public static final EntityDataAccessor<Boolean> HAS_CACTUS_TURRET = SynchedEntityData.defineId(Bmp2Entity.class, EntityDataSerializers.BOOLEAN);
    public static final EntityDataAccessor<Integer> MISSILE_FIRE_COOLDOWN = SynchedEntityData.defineId(Bmp2Entity.class, EntityDataSerializers.INT);
    ...
    public static final float X_TURRET = 0.029f / 16f;
    public static final float Y_TURRET = 29.8556f / 16f;
    public static final float Z_TURRET = -15.9918f / 16f;
    ...
    public Bmp2Entity(PlayMessages.SpawnEntity packet, Level world) {
        this(tech.vvp.vvp.init.ModEntities.BMP_2.get(), world);
    }
        ...
        return new VehicleWeapon[][]{
                new VehicleWeapon[]{
                        new SmallCannonShellWeapon()
                                .damage(VehicleConfigVVP.BMP_2_CANNON_DAMAGE.get())
                                .explosionDamage(VehicleConfigVVP.BMP_2_CANNON_EXPLOSION_DAMAGE.get())
                                .explosionRadius(VehicleConfigVVP.BMP_2_CANNON_EXPLOSION_RADIUS.get().floatValue())
                        ...
                        new WgMissileWeapon()
                                .damage(ExplosionConfigVVP.BMP_2_MISSILE_DAMAGE.get())
                                .explosionDamage(ExplosionConfigVVP.BMP_2_MISSILE_EXPLOSION_DAMAGE.get())
                                .explosionRadius(ExplosionConfigVVP.BMP_2_MISSILE_EXPLOSION_RADIUS.get())
                                .sound(ModSounds.INTO_MISSILE.get())
    ...
    public Matrix4f getBarrelTransform(float ticks) {
        ...
        Vector4f worldPosition = transformPosition(transform,  -0.125f/16f, 8.8642f/16f, 17.0359f/16f);
