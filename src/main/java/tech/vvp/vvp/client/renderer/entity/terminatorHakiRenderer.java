...
public class terminatorHakiRenderer extends GeoEntityRenderer<TerminatorHakiEntity> {

    public terminatorHakiRenderer(EntityRendererProvider.Context renderManager) {
        super(renderManager, new terminatorHakiModel());
        // this.addRenderLayer(new Bmp2Layer(this));
    }

    @Override
    public RenderType getRenderType(TerminatorHakiEntity animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
        return RenderType.entityTranslucent(getTextureLocation(animatable));
    }

    @Override
    public void preRender(PoseStack poseStack, TerminatorHakiEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green,
    ...
    @Override
    public void render(TerminatorHakiEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
        poseStack.pushPose();
    ...
    @Override
    public void renderRecursively(PoseStack poseStack, TerminatorHakiEntity animatable, GeoBone bone, RenderType renderType, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
