...
import tech.vvp.vvp.client.model.T90Model;
...
//        this.addRenderLayer(new Yx100GlowLayer(this));
    ...
    @Override
    public void preRender(PoseStack poseStack, T90Entity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green,
