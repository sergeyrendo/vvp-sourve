...
public class Mi8MTVEntity extends ContainerMobileVehicleEntity implements GeoEntity, HelicopterEntity, WeaponVehicleEntity, OBBEntity {

    private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
    public static final EntityDataAccessor<Float> PROPELLER_ROT = SynchedEntityData.defineId(Mi8MTVEntity.class, EntityDataSerializers.FLOAT);
    public static final EntityDataAccessor<Integer> LOADED_ROCKET = SynchedEntityData.defineId(Mi8MTVEntity.class, EntityDataSerializers.INT);
    public static final EntityDataAccessor<Integer> LOADED_MISSILE = SynchedEntityData.defineId(Mi8MTVEntity.class, EntityDataSerializers.INT);
    public static final EntityDataAccessor<Integer> CAMOUFLAGE_TYPE = SynchedEntityData.defineId(Mi8MTVEntity.class, EntityDataSerializers.INT);
    public static final EntityDataAccessor<Integer> FIRE_TIME = SynchedEntityData.defineId(Mi8MTVEntity.class, EntityDataSerializers.INT);
    ...
    public Mi8MTVEntity(PlayMessages.SpawnEntity packet, Level world) {
        this(ModEntities.MI_8_MTV.get(), world);
    }

    public Mi8MTVEntity(EntityType<Mi8MTVEntity> type, Level world) {
        super(type, world);
    ...
    public void vehicleShoot(LivingEntity living, int type) {
        ...
        if (getWeaponIndex(0) == 0) {
            ...
            Vector4f worldPosition = transformPosition(transform, 0.076f/16f, 0.65f, 102.7142f/16f);
            Vector4f worldPosition2 = transformPosition(transform, 0f + 0.01f, 0.65f - 0.015f, 8.85210625f);
            ...
            if (fireIndex == 0) {
                worldPosition = transformPosition(transform, 44f/16f, -19f/16f, 8f/16f);
                worldPosition2 = transformPosition(transform, 44f/16f + 0.01f, -19f/16f - 0.015f, 8.85210625f);
                fireIndex = 1;
            } else {
                worldPosition = transformPosition(transform, -44f/16f, -19f/16f, 8f/16f);
                worldPosition2 = transformPosition(transform, -44f/16f + 0.01f, -19f/16f - 0.015f, 8.85210625f);
    ...
    private PlayState firePredicate(AnimationState<Mi8MTVEntity> event) {
