...
import tech.vvp.vvp.client.model.btr80a_1Model;
...
public class btr80a_1Renderer extends GeoEntityRenderer<Btr80a_1Entity> {

    public btr80a_1Renderer(EntityRendererProvider.Context renderManager) {
        super(renderManager, new btr80a_1Model());
        // this.addRenderLayer(new btr80aLayer(this));
    }

    @Override
    public RenderType getRenderType(Btr80a_1Entity animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
        return RenderType.entityTranslucent(getTextureLocation(animatable));
    }

    @Override
    public void preRender(PoseStack poseStack, Btr80a_1Entity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green,
    ...
    @Override
    public void render(Btr80a_1Entity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
        poseStack.pushPose();
    ...
    @Override
    public void renderRecursively(PoseStack poseStack, Btr80a_1Entity animatable, GeoBone bone, RenderType renderType, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
    ...
    @Override
    protected float getDeathMaxRotation(Btr80a_1Entity entityLivingBaseIn) {
        return 0.0F;
    }
}
