...
public class ChryzantemaEntity extends ContainerMobileVehicleEntity implements GeoEntity, LandArmorEntity, WeaponVehicleEntity, OBBEntity {

    public static final EntityDataAccessor<Integer> CANNON_FIRE_TIME = SynchedEntityData.defineId(ChryzantemaEntity.class, EntityDataSerializers.INT);
    public static final EntityDataAccessor<Integer> MG_AMMO = SynchedEntityData.defineId(ChryzantemaEntity.class, EntityDataSerializers.INT);
    public static final EntityDataAccessor<Integer> CAMOUFLAGE_TYPE = SynchedEntityData.defineId(ChryzantemaEntity.class, EntityDataSerializers.INT);
    public static final EntityDataAccessor<Boolean> HAS_CACTUS_BODY = SynchedEntityData.defineId(ChryzantemaEntity.class, EntityDataSerializers.BOOLEAN);
    public static final EntityDataAccessor<Boolean> HAS_CACTUS_TURRET = SynchedEntityData.defineId(ChryzantemaEntity.class, EntityDataSerializers.BOOLEAN);
    public static final EntityDataAccessor<Boolean> HAS_MANGAL_BODY = SynchedEntityData.defineId(ChryzantemaEntity.class, EntityDataSerializers.BOOLEAN);
    public static final EntityDataAccessor<Integer> LOADED_MISSILE = SynchedEntityData.defineId(ChryzantemaEntity.class, EntityDataSerializers.INT);
    public static final EntityDataAccessor<Integer> MISSILE_COUNT = SynchedEntityData.defineId(ChryzantemaEntity.class, EntityDataSerializers.INT);
    public static final EntityDataAccessor<Integer> MISSILE_FIRE_COOLDOWN = SynchedEntityData.defineId(ChryzantemaEntity.class, EntityDataSerializers.INT);
    public static final float X_TURRET = -7.1963f / 16f;
    public static final float Y_TURRET = 37.8199f / 16f;
    public static final float Z_TURRET = 7.8783f / 16f;
    ...
    public ChryzantemaEntity(PlayMessages.SpawnEntity packet, Level world) {
        this(ModEntities.CHRYZANTEMA.get(), world);
    }

    public ChryzantemaEntity(EntityType<ChryzantemaEntity> type, Level world) {
        super(type, world);
        this.setMaxUpStep(1.5f);
        this.obb1 = new OBB(this.position().toVector3f(), new Vector3f(64f/32f, 12f/32f, 104f/32f), new Quaternionf(), OBB.Part.BODY);
        this.obb2 = new OBB(this.position().toVector3f(), new Vector3f(64f/32f, 14f/32f, 34f/32f), new Quaternionf(), OBB.Part.BODY);
        this.obb3 = new OBB(this.position().toVector3f(), new Vector3f(48f/32f, 15f/32f, 117f/32f), new Quaternionf(), OBB.Part.BODY);
        this.obb4 = new OBB(this.position().toVector3f(), new Vector3f(7f/32f, 20f/32f, 121f/32f), new Quaternionf(), OBB.Part.WHEEL_LEFT);
        this.obb5 = new OBB(this.position().toVector3f(), new Vector3f(7f/32f, 20f/32f, 121f/32f), new Quaternionf(), OBB.Part.WHEEL_RIGHT);
        this.obb6 = new OBB(this.position().toVector3f(), new Vector3f(48f/32f, 15f/32f, 18f/32f), new Quaternionf(), OBB.Part.ENGINE1);
        this.obbTurret = new OBB(this.position().toVector3f(), new Vector3f(6f/32f, 17f/32f, 6f/32f), new Quaternionf(), OBB.Part.TURRET);
    ...
    public Vec3 getTurretShootPos(Entity entity, float ticks) {
        ...
        if (getWeaponIndex(0) == 0) {
            worldPosition = transformPosition(transform, 0f, 0.5f, 2f);
        } else {
            worldPosition = transformPosition(transform, 0.0f, 0f, 0f);
        }
    ...
    public void positionRider(@NotNull Entity passenger, @NotNull MoveFunction callback) {
        ...
        Vector4f worldPosition;
        if (i == 0) {
            worldPosition = transformPosition(transform, 0f, -0.7f, 0.4f);
        } else if (i == 1) {
    ...
    public Matrix4f getBarrelTransform(float ticks) {
        ...
        Vector4f worldPosition = transformPosition(transform,  -0.453f/16f, 16.71f/16f, 17.6899f/16f);
    ...
    private PlayState firePredicate(AnimationState<ChryzantemaEntity> event) {
    ...
    public void renderFirstPersonOverlay(GuiGraphics guiGraphics, PoseStack poseStack, Font font, Player player, int screenWidth, int screenHeight, float scale, int color) {
        ...
        if (this.getWeaponIndex(0) == 0) {
            ...
            guiGraphics.drawString(font, Component.literal(" 9М123 " + (InventoryTool.hasCreativeAmmoBox(player) ? "∞" : this.getAmmoCount(player))), screenWidth / 2 - 33, screenHeight - 65, MathTool.getGradientColor(color, 0xFF0000, heat, 2), false);
        }
    }
    ...
    public void renderThirdPersonOverlay(GuiGraphics guiGraphics, Font font, Player player, int screenWidth, int screenHeight, float scale) {
        if (this.getWeaponIndex(0) == 0) {
            ...
            guiGraphics.drawString(font, Component.literal("9М123 " + (InventoryTool.hasCreativeAmmoBox(player) ? "∞" : this.getAmmoCount(player))), 30, -9, Mth.hsvToRgb(0F, (float) heat, 1.0F), false);
        }
    }
    ...
    public void updateOBB() {
        ...
        Vector4f worldPosition1 = transformPosition(transform, 0f/16, 32f/16, 17f/16);
        ...
        Vector4f worldPosition2 = transformPosition(transform, 0f/16, 32f/16, -52f/16);
        this.obb2.center().set(new Vector3f(worldPosition2.x, worldPosition2.y, worldPosition2.z));
        this.obb2.setRotation(VectorTool.combineRotations(1, this));

        Vector4f worldPosition3 = transformPosition(transform, 0f/16, 17.5f/16, 10.5f/16);
        this.obb3.center().set(new Vector3f(worldPosition3.x, worldPosition3.y, worldPosition3.z));
        this.obb3.setRotation(VectorTool.combineRotations(1, this));

        Vector4f worldPosition4 = transformPosition(transform, 27.5f/16, 12f/16, -4.5f/16);
        this.obb4.center().set(new Vector3f(worldPosition4.x, worldPosition4.y, worldPosition4.z));
        this.obb4.setRotation(VectorTool.combineRotations(1, this));

        Vector4f worldPosition5= transformPosition(transform, -27.5f/16, 12f/16, -4.5f/16);
        this.obb5.center().set(new Vector3f(worldPosition5.x, worldPosition5.y, worldPosition5.z));
        this.obb5.setRotation(VectorTool.combineRotations(1, this));

        Vector4f worldPosition6= transformPosition(transform, 0f/16, 17.5f/16, -57f/16);
        ...
        Vector4f worldPositionT = transformPosition(transformT, 0.0f, 0.25f, 0.0f);
